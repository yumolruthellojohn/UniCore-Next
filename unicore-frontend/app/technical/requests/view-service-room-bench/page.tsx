...
export default function ServiceItemBenchView() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (requestID) {
                ...
                const roomResponse = await axios.get(`http://localhost:8081/requests/service_room/${requestID}`);
    ...
    const handleEdit = () => {
        router.push(`/technical/requests/edit-service-room?id=${request.rq_id}`);
    };
