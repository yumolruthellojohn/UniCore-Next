...
export default function ServiceItemBenchView() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (requestID) {
                ...
                if (roomResponse.data[0].rq_service_user_id) {
                    const serviceStaffID = roomResponse.data[0].rq_service_user_id;
    ...
    const handleEdit = () => {
        router.push(`/technical/requests/edit-service-facility?id=${request.rq_id}`);
    };
