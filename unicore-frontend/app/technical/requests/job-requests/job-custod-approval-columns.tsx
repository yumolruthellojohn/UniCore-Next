...
export type JobCustodianApproval = {
  job_id: number
  job_rq_id: number
  job_dept_id: number
...
export const createJobCustodianApprovalColumns = (onDataChange: () => void): ColumnDef<JobCustodianApproval>[] => [
  {
    accessorKey: 'job_id',
    header: ({ column }) => (
...
export const jobCustodianApprovalColumns: ColumnDef<JobCustodianApproval>[] = createJobCustodianApprovalColumns(() => {})
