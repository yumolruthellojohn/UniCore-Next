...
export const createJobCadsApprovedColumns = (onDataChange: () => void): ColumnDef<JobCadsApproved>[] => [
  {
    accessorKey: 'job_id',
    header: ({ column }) => (
...
export const jobCadsApprovalColumns: ColumnDef<JobCadsApproved>[] = createJobCadsApprovedColumns(() => {})
