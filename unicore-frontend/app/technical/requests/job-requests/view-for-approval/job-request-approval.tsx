...
export default function EditJobRequestApprovals({ session }: EditJobRequestApprovalsProps) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            } else if (session?.user?.user_position === "CADS Staff") {
            ...
            <Card className="w-full max-w-[600px] px-4 sm:px-6 md:px-8 mt-4">
                ...
                <CardContent>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {session?.user?.user_position === "Property Custodian" && jobRequest.job_custodian_approval !== "Approved" && (
                            <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                                <Label>As a Property Custodian, this request needs your approval.</Label>
                                <br />
                        ...
                        {session?.user?.user_position === "CADS Staff" && jobRequest.job_cads_approval !== "Approved" && (
                            <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                                <Label>As a member of CADS, this request needs your approval.</Label>
                                <br />
