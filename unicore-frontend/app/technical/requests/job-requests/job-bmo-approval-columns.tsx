...
export const createJobBMOApprovalColumns = (onDataChange: () => void): ColumnDef<JobBMOApproval>[] => [
  {
    accessorKey: 'job_id',
    header: ({ column }) => (
...
export const jobBMOApprovalColumns: ColumnDef<JobBMOApproval>[] = createJobBMOApprovalColumns(() => {})
