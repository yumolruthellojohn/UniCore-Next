...
export default function EditServiceItemConflict() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await axios.put(`http://${ip_address}:8081/requests/service_item_conflict/${requestId}`, formData);
            
            // Then create a notification for the respondent
            const notificationData = {
                notif_user_id: formData.rq_accept_user_id, // The respondent's ID
                notif_type: 'service_item_update_conflict',
