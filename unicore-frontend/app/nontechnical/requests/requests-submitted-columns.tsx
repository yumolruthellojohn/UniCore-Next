    ...
    cell: ({ row }) => {
      ...
      const handleView = async () => {
        ...
        switch (requestQueue.rq_type) {
          case "Reserve Item":
            url = `/nontechnical/requests/view-reserve-item?id=${requestQueue.rq_id}`;
            break;
          case "Reserve Facility":
            url = `/nontechnical/requests/view-reserve-facility?id=${requestQueue.rq_id}`;
            break;
          default:
            url = `/nontechnical/requests/`; // Fallback URL
        }
        router.push(url);
      }
