...
[Date]`,
    ...
    const handleDialogClose = () => {
        ...
        router.push('/admin/requests/job-requests'); // Adjust this path to your job requests page route
    };
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(value) => handleChange('job_create_user_id', value)} defaultValue={formData.job_create_user_id} required>
                                <SelectTrigger>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(value) => handleChange('job_dept_id', value)} defaultValue={formData.job_dept_id} required>
                                <SelectTrigger>
