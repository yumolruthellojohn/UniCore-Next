...
export const createReserveItemColumns = (onDataChange: () => void): ColumnDef<ReserveItem>[] => [
  {
    accessorKey: 'rq_id',
    header: ({ column }) => (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const handleDelete = async () => {
        try {
          await axios.delete(`http://${ip_address}:8081/requests/${reserveItem.rq_id}`)
          toast({
...
export const reserveItemColumns: ColumnDef<ReserveItem>[] = createReserveItemColumns(() => {})