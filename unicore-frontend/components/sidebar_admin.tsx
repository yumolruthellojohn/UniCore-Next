              ...
              {sidebarItems.map((item) => (
                <div key={item.label}>
                  ...
                  {item.label === "Requests" && (
                    ...
                    >
                      <Link href="/admin/requests" className="block px-3 py-2 text-muted-foreground hover:text-primary">
                        Standard
                      </Link>
                      <Link href="/admin/requests/job-requests" className="block px-3 py-2 text-muted-foreground hover:text-primary">
                        BMO Job Requests
                      </Link>
                    </div>
                  )}
