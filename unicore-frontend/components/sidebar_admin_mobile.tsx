              ...
              {sidebarItems.map((item) => (
                <div key={item.label}>
                  ...
                  {item.label === "Requests" && (
                    ...
                    >
                      <Link href="/admin/requests" className="block px-3 py-2 text-muted-foreground hover:text-primary" onClick={handleLinkClick}>
                        Standard
                      </Link>
                      <Link href="/admin/requests/job-requests" className="block px-3 py-2 text-muted-foreground hover:text-primary" onClick={handleLinkClick}>
                        BMO Job Requests
                      </Link>
                    </div>
                  )}
