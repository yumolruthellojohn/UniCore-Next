...
export function NotificationBellNonTechnical({ userId }: { userId: number }) {
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    switch (notification.notif_type) {
      case 'reserve_item_update':
        router.push(`/nontechnical/requests/view-reserve-item?id=${notification.notif_related_id}`)
        break
      case 'reserve_facility_update':
        router.push(`/nontechnical/requests/view-reserve-facility?id=${notification.notif_related_id}`)
        break
      case 'schedule_new':
        router.push(`/nontechnical/wschedules/view?id=${notification.notif_related_id}`)
        break
      case 'schedule_update':
        router.push(`/nontechnical/wschedules/view?id=${notification.notif_related_id}`)
        break
      case 'schedule_remove':
        router.push(`/nontechnical/wschedules`)
        break
