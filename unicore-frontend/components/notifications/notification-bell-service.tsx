...
export function NotificationBellService({ userId }: { userId: number }) {
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    switch (notification.notif_type) {
      case 'service_facility_assigned':
        router.push(`/service/requests/view-service-facility?id=${notification.notif_related_id}`)
        break
      case 'service_facility_unassigned':
        router.push(`/service/requests`)
        break
      case 'service_item_assigned':
        router.push(`/service/requests/view-service-item?id=${notification.notif_related_id}`)
        break
      case 'service_item_unassigned':
        router.push(`/service/requests`)
        break
